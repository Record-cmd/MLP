...
for i in range(iters_num):
    ...
    t_batch = y_train_enc[batch_mask]
    ...
    if i % iter_per_epoch == 0:
        ...
        train_acc = network.accuracy(x_train_resampled, y_train_enc)
        ...
        train_class_acc, Train_Class_0_acc, Train_Class_1_acc, Train_Class_2_acc, Train_G_Mean  = network.accuracy2(x_train_resampled, y_train_enc)
